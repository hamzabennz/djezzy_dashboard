...
5. Install surveillance`
  ...
  return (
    <>
      ...
      <button 
        className="fixed bottom-6 left-6 bg-navy-800 hover:bg-navy-700 text-white rounded-lg p-3 shadow-lg transition-all duration-200"
      ...
      {/* Terminal window */}
      {isOpen && (
        <div className="fixed bottom-20 left-6 w-[600px] h-[400px] bg-navy-900 rounded-lg shadow-xl border border-navy-800 flex flex-col">
          {/* Terminal header */}
          <div className="flex items-center justify-between px-4 py-2 border-b border-navy-800 bg-navy-800 rounded-t-lg">
