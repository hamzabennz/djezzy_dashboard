...
const Header: React.FC = () => {
  ...
  return (
    <header className="bg-white px-6 py-4 flex flex-wrap items-center gap-4 border-b border-gray-200">
      <div className="flex items-center gap-3 mr-auto">
        <Logo className="h-8 w-8 text-primary" />
        <div>
          <h1 className="text-xl font-bold text-gray-900">NetTowerGuard</h1>
      ...
      <div className="flex items-center gap-6">
        <div className="text-sm">
          <div className="text-gray-500">{currentTime.toLocaleDateString()}</div>
        ...
        <div className="flex gap-4">
          ...
          <Stat icon={<Signal />} label="Active" value={activeTowers} color="text-success" />
          <Stat icon={<AlertTriangle />} label="At Risk" value={atRiskTowers} color="text-warning" />
        </div>
      </div>
    </header>
  );
