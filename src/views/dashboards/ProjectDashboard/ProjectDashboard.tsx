...
import { Calendar, Clock, AlertTriangle, Check, Activity, Zap, ArrowUpCircle, ChevronLeft, ChevronRight, AlarmClock, AlertOctagon, Server } from 'lucide-react';

const NetworkTowerDashboard = () => {
  ...
  const data = {
    ...
    riskTowers: [
      { id: 'TWR-1042', riskScore: 89, failureType: 'Hardware Malfunction', predictedDowntime: '4.5 hours', lastFailure: '22 days ago' },
      { id: 'TWR-0587', riskScore: 76, failureType: 'Power Outage', predictedDowntime: '2.8 hours', lastFailure: '15 days ago' },
      { id: 'TWR-2311', riskScore: 74, failureType: 'Hardware Malfunction', predictedDowntime: '3.1 hours', lastFailure: '30 days ago' },
      { id: 'TWR-0892', riskScore: 68, failureType: 'Software Error', predictedDowntime: '1.5 hours', lastFailure: '45 days ago' },
    ],
    downtimeTrend: [
    ...
    calendarPredictions: {
      ...
      "2025-04-21": { count: 3, risk: "high", towers: ["TWR-1042", "TWR-0587", "TWR-0331"], primaryType: "Hardware Malfunction" },
      "2025-04-22": { count: 1, risk: "medium", towers: ["TWR-2311"], primaryType: "Power Outage" },
      "2025-04-24": { count: 2, risk: "medium", towers: ["TWR-0892", "TWR-1157"], primaryType: "Software Error" },
      "2025-04-25": { count: 4, risk: "critical", towers: ["TWR-1042", "TWR-0587", "TWR-2176", "TWR-3311"], primaryType: "Hardware Malfunction" },
      "2025-04-28": { count: 2, risk: "high", towers: ["TWR-0587", "TWR-1621"], primaryType: "Weather Damage" },
      "2025-04-30": { count: 2, risk: "medium", towers: ["TWR-0892", "TWR-1157"], primaryType: "Connectivity Issue" },
    },
    ...
    dayPredictions: {
      "2025-04-25": [
        { 
          ...
          recommendation: "Replace primary circuit board and test backup power systems"
        },
        { 
          towerId: "TWR-0587", 
          ...
          recommendation: "Check cooling system and replace thermal paste on processors"
        },
        { 
          towerId: "TWR-2176", 
          ...
          recommendation: "Replace power supply unit and verify voltage regulators"
        },
        { 
          towerId: "TWR-3311", 
          ...
          recommendation: "Perform full diagnostic and check main board connections"
        }
      ]
    }
  };
  ...
  const RiskBadge = ({ risk }) => {
    ...
    return (
      <span className={`px-2 py-1 rounded-full text-xs font-medium ${colorMap[risk]}`}>
  ...
  return (
    <div className="p-4 bg-gray-50 min-h-screen">
      <h1 className="text-2xl font-bold mb-6">Network Tower Failure Prediction Dashboard</h1>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col xl:flex-row gap-4">
            ...
            <div className=" p-4 rounded-lg shadow flex-1">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-lg font-semibold">Failure Prediction Calendar</h2>
                <div className="flex items-center">
                  <button 
                      ...
                      <div className="h-full flex flex-col">
                        ...
                        {dayObj.prediction && (
                          <div className="flex-1 flex flex-col items-center justify-center mt-1">
                            ...
                            `}>
                              {dayObj.prediction.count}
                            </div>
                            <div className="text-xs text-center mt-1 truncate w-full">
                              {dayObj.prediction.primaryType.split(' ')[0]}
                            </div>
                          </div>
                        )}
                      </div>
            ...
            <div className=" p-4 rounded-lg shadow flex-1">
              ...
              {!selectedDay && (
                <div className="flex flex-col items-center justify-center h-64 text-gray-500">
                  <Calendar size={48} />
                  <p className="mt-4">Select a day on the calendar to view detailed predictions</p>
                </div>
              )}
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    <div className="flex items-center">
                      ...
                      <span className="font-medium">{selectedDay.prediction.count} Predicted Failures</span>
                    </div>
                    <RiskBadge risk={selectedDay.prediction.risk} />
                  </div>
                    ...
                    {selectedDayDetails.map((detail, index) => (
                      <div key={index} className="bg-gray-50 p-4 rounded-lg mb-3">
                        <div className="flex justify-between items-start mb-2">
                          <div className="font-medium text-lg">{detail.towerId}</div>
                          <RiskIndicator score={detail.riskScore} />
                        </div>
                        <div className="grid grid-cols-2 gap-2 text-sm mb-3">
                          <div>
                            <span className="text-gray-500">Location:</span> {detail.location}
                          </div>
                          <div>
                            <span className="text-gray-500">Failure Type:</span> {detail.failureType}
                          </div>
                          <div className="flex items-center">
                            <AlarmClock size={14} className="mr-1" /> 
                            <span className="text-gray-500 mr-1">Predicted Time:</span> {detail.predictedTime}
                          </div>
                          <div>
                            <span className="text-gray-500">Est. Downtime:</span> {detail.estimatedDowntime}
                          </div>
                          <div>
                            <span className="text-gray-500">Impacted Users:</span> {detail.impactedUsers.toLocaleString()}
                          </div>
                          <div>
                            <span className="text-gray-500">Maintenance Window:</span> {detail.maintenanceWindow}
                          </div>
                        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
            ...
            <div className="bg- p-4 rounded-lg shadow">
              <h2 className="text-lg font-semibold mb-4">Failure Type Distribution</h2>
              <div className="flex justify-center">
                <PieChart width={250} height={250}>
                  ...
                  >
                    {data.failureTypePrediction.map((entry, index) => (
            ...
            <div className="whitebg- p-4 rounded-lg shadow">
              <h2 className="text-lg font-semibold mb-4">Weekly Failure Prediction</h2>
              <LineChart width={300} height={250} data={data.timelinePrediction} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                <CartesianGrid strokeDasharray="3 3" />
                <XAxis dataKey="day" />
                <YAxis />
                <Tooltip />
                <Legend />
                <Line type="monotone" dataKey="predictions" stroke="#8884d8" name="Predicted" />
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-gray-50 p-3 rounded-lg">
                  ...
                  <div className="flex items-end">
                    <span className="text-2xl font-bold">{data.modelPerformance.accuracy}%</span>
                ...
                <div className="bg-gray-50 p-3 rounded-lg">
                  ...
                  <div className="flex items-end">
                    <span className="text-2xl font-bold">{data.modelPerformance.precision}%</span>
                    <div className="ml-2 h-16 w-16">
                      <div className="w-full h-full relative">
                        <div className="absolute inset-0 rounded-full bg-gray-200"></div>
                        <div 
                ...
                <div className="bg-gray-50 p-3 rounded-lg">
                  ...
                  <div className="flex items-end">
                    <span className="text-2xl font-bold">{data.modelPerformance.recall}%</span>
                    <div className="ml-2 h-16 w-16">
                      <div className="w-full h-full relative">
                        <div className="absolute inset-0 rounded-full bg-gray-200"></div>
                        <div 
                ...
                <div className="bg-gray-50 p-3 rounded-lg">
                  ...
                  <div className="flex items-end">
                    <span className="text-2xl font-bold">{data.modelPerformance.f1Score}%</span>
                    <div className="ml-2 h-16 w-16">
                      <div className="w-full h-full relative">
                        <div className="absolute inset-0 rounded-full bg-gray-200"></div>
                        <div 
...
export default NetworkTowerDashboard;