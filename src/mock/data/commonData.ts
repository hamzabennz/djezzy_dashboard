...
export const notificationListData = [
    {
        ...
        description: 'Critical network outage detected in Algiers region.',
        date: '2 minutes ago',
        image: 'warning.jpg',
        type: 2,
        location: 'Algiers',
        locationLabel: 'Critical',
        status: 'failed',
        readed: false,
    },
    {
    ...
    },
    {
        ...
        description:
            'Bandwidth usage exceeding threshold in Constantine sector.',
        date: '3 hours ago',
        image: 'alert.jpg',
        type: 1,
        location: 'Constantine',
        locationLabel: 'Warning',
        status: 'warning',
        readed: false,
    },
    {
        ...
        target: 'Ahmed Benali',
        description: 'updated the network configuration in Annaba region.',
        date: '4 hours ago',
        image: 'thumb-4.jpg',
        type: 0,
        location: 'Annaba',
    ...
    },
    {
        ...
        target: 'Equipment Alert',
        description: 'Router malfunction detected at Sétif station.',
        date: '2 days ago',
        image: 'error.jpg',
        type: 2,
        location: 'Sétif',
        locationLabel: 'Hardware',
        status: 'failed',
        readed: true,
    },
    {
        ...
        description: 'Network firmware update successfully deployed.',
        date: '4 days ago',
        image: 'update.jpg',
        type: 2,
        location: 'All Regions',
        locationLabel: 'System',
        status: 'succeed',
        readed: true,
    },
]
